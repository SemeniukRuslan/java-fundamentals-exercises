...
public class CrazyGenerics {
    ...
    interface CollectionRepository<T
            extends BaseEntity, C extends Collection<T>> { // todo: update interface according to the javadoc
        void save(T entity);
    ...
    interface ListRepository<T extends BaseEntity>
            extends CollectionRepository<T, List<T>> { // todo: update interface according to the javadoc
    }

...
public class CrazyLambdas {
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        return (s, i) -> String.valueOf(s).repeat(i);
     ...
     * that accepts str to str function and returns the same function
     * composed with trim
     *
    ...
    /**
     * Receives a {@link Runnable} parameter, and returns a {@link Supplier<Thread>}.
     * The thread will be started only when you call supplier method {@link Supplier#get()}
     *
    ...
    public static Consumer<Runnable> newThreadRunnableConsumer() {
        return x -> new Thread(x).start();
    }

    /**
     * Returns a {@link Function} that accepts an instance of {@link Runnable}
     * and returns a {@link Supplier} of a
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (function, condition) -> x ->
                condition.test(x) ? function.applyAsInt(x) : x;
    }
